...
public class ControlsPanel extends JPanel {
    ...
    private void generateMaze(ActionEvent event) {
        ...
        this.start = baseMaze.getRoom(new Point(bound.x + 5, bound.y + 5));
        this.end = baseMaze.getRoom(new Point(bound.x + bound.width - 5, bound.y + bound.height - 5));

        this.drawer.drawWalls(finalMaze.walls());
        this.drawer.drawPoint(start.getCenter());
        this.drawer.drawPoint(end.getCenter());
    }
